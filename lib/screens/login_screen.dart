          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                child:
                    const Text(" Giris Yap ", style: TextStyle(fontSize: 12)),
              ),
              SizedBox(height: 12),
              ElevatedButton(
                onPressed: () {
                ...
                child: const Text("Kayit Ol", style: TextStyle(fontSize: 12)),
              ),
              SizedBox(height: 24),
              OutlinedButton.icon(
                onPressed: () {},
                ...
                icon: Image.asset('assets/icons/googleicons.png', height: 24),
              ...
              OutlinedButton.icon(
                ...
                icon: Image.asset('assets/icons/appleicons.png', height: 24),
